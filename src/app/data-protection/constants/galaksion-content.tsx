        ...
        <>
            <div>
                <SectionText>
                    ...
                    ____________ (“Customer“) and (ii) GALAKSION GROUP SIA
                    (“Company“).
                </SectionText>
                <SectionText>
            ...
            <div>
                <SectionHeadline id="defin" label="Definitions">1. DEFINITIONS</SectionHeadline>
                <SectionText>
            ...
            <div>
                <SectionHeadline id="int" label="Introduction">2. INTRODUCTION</SectionHeadline>
                <SectionText>
            ...
            <div>
                <SectionHeadline id="appl" label="Application of this DPA">
            ...
            <div>
                <SectionHeadline id="data" label="Processing of Personal Data">
                    4. PROCESSING OF PERSONAL DATA
                </SectionHeadline>
                <SectionText>
                    4.1 <span>Independent Controllers.</span> Each party:
                </SectionText>
                <SectionText>
                ...
                <SectionText>
                    4.2 <span>Contracted Processors.</span> Each Party shall:
                </SectionText>
                <SectionText>
                ...
                <SectionText>
                    4.4 <span>Sharing of Personal Data.</span> In performing its
                    obligations under the Principle Agreement, a Party may
                    provide Personal Data to the other Party. Each party shall
                    process Personal Data only for (i) the purposes set forth in
                    the Principle Agreement or as (ii) otherwise agreed to in
                    writing by the parties, provided such processing strictly
                    complies with (iii) Data Protection Laws, (ii) Relevant
                    Privacy Requirements and (iii) its obligations under this
                    DPA (the “Permitted Purposes”). Each Party shall not
                ...
                <SectionText>
                    4.5 <span>Lawful grounds and transparency.</span>
                ...
                <SectionText>
                    4.6 <span>Data Subject Rights.</span> It is agreed that
                    where either party receives a request from a Data Subject in
                    respect of Personal Data controlled by such Party, then such
                    Party shall be responsible to exercise the request, in
                    accordance with Data Protection Laws.
                </SectionText>
            </div>
            <div>
                <SectionHeadline id="trans" label="Transfers of Personal Data">
            ...
            <div>
                <SectionHeadline id="sec" label="SECURITY AND PROTECTION OF PERSONAL DATA">
            ...
            <div>
                <SectionHeadline id="subp" label="Subprocessing">7. SUBPROCESSING</SectionHeadline>
                <SectionText>
            ...
            <div>
                <SectionHeadline id="prot" label="Data Protection Impact Assessment and Prior Consultation">
            ...
            <div>
                <SectionHeadline id="del" label="Deletion or Return of Company Personal Data">
            ...
            <div>
                <SectionHeadline id="lia" label="Liability">10. LIABILITY</SectionHeadline>
                <SectionText>
            ...
            <div>
                <SectionHeadline id="gen" label="General Terms Governing Law and Jurisdiction">
